        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
              ...
              <br />
              We Build Businesses in Sydney.
            </h1>

            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed mb-8">
              From business analysis to brand recognition, STENTH drives every stage of your growth in Australia's economic capital. Complete digital marketing solutions for Sydney businesses.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Complete digital marketing solutions for Sydney businesses. Every service designed to drive measurable business growth.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">
              Growth Packages for Sydney Businesses
            </h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              ...
              >
                {pkg.popular && (
                  <div className="text-center mb-4">
                    <span className="inline-block px-4 py-1 bg-purple-500 text-white text-sm font-semibold rounded-full">
                      MOST POPULAR
                    </span>
                  </div>
                )}
          ...
          <div className="text-center">
            ...
            <Link
              href="/au/contact"
              className="inline-block px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-bold rounded-xl hover:from-cyan-600 hover:to-purple-700 transition-all duration-300"
            >
              Get Custom Quote
            </Link>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Local expertise with global standards. We understand Sydney's unique business landscape and market dynamics.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-white mb-8">
              Why Sydney Businesses Choose STENTH
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                ...
                <p className="text-slate-300">Track record of driving measurable business growth for Sydney companies across all industries.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Sydney Expertise</h3>
                <p className="text-slate-300">Deep understanding of Sydney's business environment, from startups to ASX-listed companies.</p>
              </div>
            </div>

            {/* Final CTA */}
            <div className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700/50">
              <h3 className="text-2xl font-bold text-white mb-6">Ready to Build Your Business in Sydney?</h3>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-8">
                <div className="flex items-center">
                  <Phone className="w-5 h-5 text-cyan-400 mr-3" />
                  <span className="text-white">+61 2 8015 4285</span>
                </div>
                <div className="flex items-center">
              ...
              <div className="space-y-4">
                <Link
                  href="/au/contact"
                  className="inline-block px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold rounded-xl hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 shadow-lg transform hover:scale-105"
                >
